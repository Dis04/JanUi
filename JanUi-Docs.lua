...
LegitMain:AddToggle {text = "Enabled", flag = "CircleEnabled"}:AddColor(
    {flag = "CircleColor", color = Color3.new(1, 1, 1)}
)
...
LegitForth:AddList(
    {text = "Redirection Mode", flag = "RedirectionMode", value = "P Mode", values = {"P Mode", "Normal Mode"}}
)
LegitForth:AddList({text = "Hit Box", flag = "SilentAimHitbox", value = "Head", values = {"Head", "Torso"}})
LegitForth:AddDivider("Draw Fov")
LegitForth:AddToggle {text = "Enabled", flag = "Circle2Enabled"}:AddColor(
    {flag = "Circle2Color", color = Color3.new(1, 1, 1)}
)
...
VisualsMain:AddToggle {text = "Custom Arm", flag = "CustomArm"}:AddColor(
    {
        flag = "ArmColor",
        color = Color3.new(0.599623620510101318359375, 0.447115242481231689453125, 0.97174417972564697265625)
    }
)
VisualsMain:AddSlider {
    text = "Transparency",
    flag = "ArmTransparency",
    min = 0.10,
    max = 0.95,
    float = 0.01,
    value = 0.85,
...
VisualsMain:AddList(
    {text = "Material", flag = "ArmMaterial", value = "ForceField", values = {"ForceField", "Neon", "SmoothPlastic"}}
)
VisualsMain:AddToggle {text = "Custom Weapon", flag = "CustomWeapon"}:AddColor(
    {flag = "WeaponColor", color = Color3.new(1, 1, 1)}
)
VisualsMain:AddSlider {
    text = "Transparency",
...
VisualsMain:AddList(
    {text = "Material", flag = "WeaponMaterial", value = "ForceField", values = {"ForceField", "Neon", "SmoothPlastic"}}
)
VisualsMain:AddDivider("Mesh")
VisualsMain:AddToggle {text = "Enabled", flag = "TextureEnabled"}
VisualsMain:AddList(
    {text = "Arm Animation", flag = "ArmAnimation", value = "Bubbles", values = {"Bubbles", "Scanning"}}
)
VisualsMain:AddList(
    {text = "Weapon Animation", flag = "WeaponAnimation", value = "Bubbles", values = {"Bubbles", "Scanning"}}
)
VisualsMain:AddDivider("Third Person")
VisualsMain:AddToggle {text = "Enabled", flag = "ThirdPersonEnabled"}:AddColor(
    {flag = "ThirdPersonColor", color = Color3.new(1, 1, 1)}
)
VisualsMain:AddList(
    {text = "Material", flag = "ThirdPersonMaterial", value = "ForceField", values = {"ForceField", "SmoothPlastic"}}
)
...
SettingSection:AddColor(
    {
        ...
        callback = function(color)
            ...
            for i, v in pairs(library.theme) do
                v[
                        (v.ClassName == "TextLabel" and "TextColor3") or (v.ClassName == "ImageLabel" and "ImageColor3") or
                            "BackgroundColor3"
                    ] = color
            end
        end
...
local backgroundlist = {
    ...
    Hearts = "rbxassetid://5635434569",
    --thing = "rbxassetid://5635434569"
}
...
ConfigSection:AddList(
    {text = "Configs", skipflag = true, value = "", flag = "Config List", values = library:GetConfigs()}
)
...
ConfigSection:AddButton(
    {
        ...
        callback = function()
            ...
            Warning.text =
                ...
                r .. "," .. g .. "," .. b .. ")'>" .. library.flags["Config List"] .. "</font>?"
            ...
            if Warning:Show() then
                ...
                if
                    table.find(library:GetConfigs(), config) and
                        isfile(library.foldername .. "/" .. config .. library.fileext)
                 then
